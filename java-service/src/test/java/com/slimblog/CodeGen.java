...
public class CodeGen {
    static String url = "jdbc:mysql://localhost:3306/slimblog?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=Asia/Shanghai";
    ...
    public void generateCode() {
        FastAutoGenerator.create(url, "root", "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.slimblog") // 设置父包名
                            .moduleName("") // 设置父包模块名
