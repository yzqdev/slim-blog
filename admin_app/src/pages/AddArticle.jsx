...
import {addArticleApi, getArticleByIdApi, getTypeInfoApi, updateArticleApi} from "@/utils/admin";
...
export default function AddArticle(props) {
    ...
    const getArticleById = (id) => {
        getArticleByIdApi(id).then(
            res => {
                console.log(res)
                console.log(`%c获取文章byid`, `color:red;font-size:16px;background:transparent`)
                setIsLoadding(false)
                ...
                setShowDate(res.data.add_time)
                setSelectType(res.data.type_id)
                setPartCount(res.data.part_count)
